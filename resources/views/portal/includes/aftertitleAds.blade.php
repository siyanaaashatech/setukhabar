...
<body>
    <div class="container">
        <div class="top_ad">
            ...
            @if ($afterPosttitleAd && $afterPosttitleAd->status == 0)
            <div class="top_ad">
                <a target="_blank" href="{{ $afterPosttitleAd->url ?? '#' }}">
                    <img src="{{ asset('uploads/images/ads/' . ($afterPosttitleAd->image ?? 'default.jpg')) }}" alt="">
                </a>
            </div>
            @else
